...
<body>
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="/admin/pages/finance_list.php" class="bg-indigo-600 px-4 py-3 rounded-xl font-bold" class="sidebar-link flex items-center gap-3 hover:bg-white/5 px-4 py-3 rounded-xl transition-colors"><i class="fas fa-wallet w-5"></i> 财务充提审批</a>
