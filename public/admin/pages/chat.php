...
<body>
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="/admin/pages/chat.php" class="bg-indigo-600 px-4 py-3 rounded-xl font-bold" class="sidebar-link flex items-center gap-3 hover:bg-white/5 px-4 py-3 rounded-xl transition-colors"><i class="fas fa-headset w-5"></i> 在线客服中心</a>
